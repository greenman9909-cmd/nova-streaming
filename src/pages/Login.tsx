...
export default function Login() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Use username as email for mock auth if simple string, or actual email
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="glass-dark rounded-3xl p-8 md:p-10">
                    ...
                    <p className="text-center mt-8 text-nova-muted">
                        ...
                        <a href="#" className="text-nova-accent hover:text-nova-accent-hover transition-colors font-medium">
                            Sign up
                        </a>
                    </p>
                </div>
